...
namespace Lesson07.Data
{
    public class InventoryDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=WIN-37KMC9AKIMF;Initial Catalog=InventoryManagement;Integrated Security=True;Pooling=False;Encrypt=False;Trust Server Certificate=False");
